...
hasilBank = WebUI.getText(findTestObject('Object Repository/Data Bank/div_hasilNamaBank5'))

hasilNorek = WebUI.getText(findTestObject('Object Repository/Data Bank/div_hasilNorek5'))

hasilNama = WebUI.getText(findTestObject('Object Repository/Data Bank/div_hasilAtasNama5'))

//WebUI.verifyElementPresent(findTestObject('Object Repository/Data Bank/nama bank tambah'), 0)
