...
if (hanyaHuruf(atasnama)) {
    WebUI.click(findTestObject('Data Bank/button_Simpan Rekening Bank'))

    hasilBank = WebUI.getText(findTestObject('Object Repository/Data Bank/hasil nama bank'))
    ...
    WebUI.verifyTextPresent('Nama bank hanya boleh mengandung huruf!', false)
}

boolean hanyaHuruf(String input) {
