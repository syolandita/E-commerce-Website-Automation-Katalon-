...
if (alamat.find("[^$specialCharacters]")) {
	WebUI.click(findTestObject('Edit Toko/tombol simpan perubahan'))
	
		hasilAlamat = WebUI.getText(findTestObject('Edit Toko/verifikasi alamat lengkap'))
	
		assert alamat == hasilAlamat
	
    
} else {
	WebUI.verifyTextPresent('alamat tidak boleh menggunakan special character!', false)
}
