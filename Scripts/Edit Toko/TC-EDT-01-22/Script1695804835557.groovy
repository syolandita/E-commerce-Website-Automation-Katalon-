...
WebUI.setText(findTestObject('Edit Toko/input_Alamat Lengkap'), alamat)

WebUI.setText(findTestObject('Edit Toko/input_Kontak Toko'), kontak)

WebUI.setText(findTestObject('Edit Toko/input_keterangan'), deskirpsi)

if (((spasi(namaToko) || spasi(alamat)) || spasi(kontak)) || spasi(deskripsi)) {
    WebUI.verifyTextPresent('Field tidak boleh di isi hanya menggunakan spasi!', false)
} else {
