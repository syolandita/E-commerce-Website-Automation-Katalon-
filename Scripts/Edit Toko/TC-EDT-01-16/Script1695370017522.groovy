...
WebUI.setText(findTestObject('Edit Toko/input_keterangan'), deskripsi)

if(deskripsi.equals("")) {
	WebUI.verifyTextPresent("Please fill this field!", false)
} else {
	WebUI.click(findTestObject('Edit Toko/tombol simpan perubahan'))
	hasilDeskripsi = WebUI.getText(findTestObject('Edit Toko/verify deksripsi'))
	assert deskripsi == hasilDeskripsi
}