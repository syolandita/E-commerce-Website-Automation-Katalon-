...
if (kontak.startsWith("+62")) {
	WebUI.verifyTextPresent('Nomor kontak toko tidak boleh menggunakan +62', false)
}else {
	WebUI.click(findTestObject('Edit Toko/tombol simpan perubahan'))
	hasilNomorKontak = WebUI.getText(findTestObject('Object Repository/Edit Toko/verfikasi kontak'))
	assert kontak == hasilNomorKontak
}
