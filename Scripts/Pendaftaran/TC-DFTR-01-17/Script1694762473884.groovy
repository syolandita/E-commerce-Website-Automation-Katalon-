...
WebElement email = webDriver.findElement(By.xpath('(//input[@name="b"])[4]'))

error_message = ((webDriver) as JavascriptExecutor).executeScript('return arguments[0].validationMessage', email)

println(error_message)

assert error_message == 'Please enter a valid value. The two nearest valid values are 0 and 1.'
