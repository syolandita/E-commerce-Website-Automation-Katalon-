...
if (noHP.startsWith("-")) {
    WebUI.comment("Pengujian gagal: Nomor handphone tidak boleh diawali dengan tanda '-'")
} else {
    WebUI.comment("Pengujian berhasil: Nomor handphone tidak diawali dengan tanda '-'")
}
...
if (!noHP.startsWith("-")) {
	...
	WebUI.click(findTestObject('Register/button_Daftar'))
    WebUI.verifyTextPresent("Nomor handphone tidak boleh diawali dengan tanda '-'!", false)
}