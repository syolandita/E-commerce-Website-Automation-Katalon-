...
def isEmailValid(email) {
    def emailRegex = /^[a-zA-Z0-9]+@[a-zA-Z0-9]+\.[a-zA-Z]$/
...
if (!isEmailValid(email)) {
    WebUI.verifyTextPresent('Alamat email tidak boleh menggunakan karakter khusus (special character) selain "@" dan "."!', false)
} else {
