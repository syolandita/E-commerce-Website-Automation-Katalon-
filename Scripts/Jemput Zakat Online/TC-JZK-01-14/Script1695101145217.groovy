...
WebElement noHP = webDriver.findElement(By.xpath('//input[@name="no_handphone"]'))

error_message = ((webDriver) as JavascriptExecutor).executeScript('return arguments[0].validationMessage', noHP)
