...
WebUI.verifyElementPresent(findTestObject('Zakat/div_2 Digit salah'), 0)

WebUI.verifyTextPresent('GAGAL Diproses, 2 Digit Terakhir No Handphone yang anda input salah!', false)
